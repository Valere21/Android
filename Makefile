#############################################################################
# Makefile for building: appProjetAlarme
# Generated by qmake (3.1) (Qt 5.12.5)
# Project:  appProjetAlarme.pro
# Template: app
# Command: /home/crashkart/raspi/qt5/bin/qmake -o Makefile appProjetAlarme.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = appProjetAlarme1.0.0
DISTDIR = /home/crashkart/Projet-Alarme/.tmp/appProjetAlarme1.0.0
...
DIST          = ../raspi/qt5/mkspecs/features/spec_pre.prf \
		...
		appProjetAlarme.pro interface.h \
		serial.h interface.cpp \
		interfacefunc.cpp \
		interfaceview.cpp \
		main.cpp \
		serial.cpp
QMAKE_TARGET  = appProjetAlarme
DESTDIR       = 
TARGET        = appProjetAlarme


first: all
####### Build rules

appProjetAlarme:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: appProjetAlarme.pro ../raspi/qt5/mkspecs/devices/linux-rasp-pi-g++/qmake.conf ../raspi/qt5/mkspecs/features/spec_pre.prf \
		../raspi/qt5/mkspecs/common/unix.conf \
		../raspi/qt5/mkspecs/common/linux.conf \
		../raspi/qt5/mkspecs/common/sanitize.conf \
		../raspi/qt5/mkspecs/common/gcc-base.conf \
		...
		appProjetAlarme.pro \
		qml.qrc
	$(QMAKE) -o Makefile appProjetAlarme.pro
...
moc_interface.cpp: interface.h \
		...
		../raspi/qt5pi/include/QtGui/QGuiApplication \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/appProjetAlarme/bin || mkdir -p $(INSTALL_ROOT)/opt/appProjetAlarme/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/appProjetAlarme/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/appProjetAlarme/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/appProjetAlarme/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/appProjetAlarme/bin/ 
